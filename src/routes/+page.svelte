<script>
    ...
    const socialLinks = [
        { icon: 'fa-brands fa-github', href: 'https://github.com/aliirsyaadn', label: 'GitHub' },
        { icon: 'fa-brands fa-linkedin', href: 'https://linkedin.com/in/aliirsyaadn', label: 'LinkedIn' },
        { icon: 'fa-brands fa-x-twitter', href: 'https://x.com/aliirsyaadn', label: 'X' }
    ];
</script>

<svelte:head>
    <title>Ali Irsyaad | Software Engineer</title>
    <meta name="description" content="Software Engineer specializing in Backend Engineering with Go and Python" />
</svelte:head>

<!-- Hero Section -->
<section class="min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
    <div class="max-w-4xl mx-auto text-center page-enter">
        <!-- Status Badge -->
        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8"
            ...
            <span class="text-sm" style="color: var(--text-secondary);">Building at Paper.id</span>
        </div>

        <!-- Main Title -->
        <h1 class="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold mb-6 leading-tight">
            <span style="color: var(--text-primary);">I'm </span>
            <span class="text-accent-gradient">Ali Irsyaad</span>
        </h1>

        <!-- Subtitle -->
        <p class="text-lg sm:text-xl md:text-2xl mb-8 max-w-2xl mx-auto" style="color: var(--text-secondary);">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a href="/about" class="btn-secondary inline-flex items-center gap-2">
                <span>About Me</span>
            </a>
        </div>
...
<section class="py-24 px-6">
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center justify-between mb-12">
            ...
            <a href="/projects" class="link-hover text-sm flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {#each featuredProjects as project, i}
                <article class="card p-6 stagger-item" style="animation-delay: {i * 0.1}s">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center"
                            style="background: var(--bg-tertiary);">
                            <i class="fa-solid fa-folder" style="color: var(--accent);"></i>
                        </div>
                        <h3 class="font-display font-semibold" style="color: var(--text-primary);">
                            {project.title}
                        </h3>
                    </div>
...
<section class="py-24 px-6" style="background: var(--bg-secondary);">
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center justify-between mb-12">
            <div>
                <h2 class="text-3xl sm:text-4xl font-display font-bold mb-2">
                ...
                <p style="color: var(--text-secondary);">Thoughts and tutorials</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {#each recentBlogs as post, i}
                <a href="/blog/{post.slug}" class="card p-6 stagger-item block group" style="animation-delay: {i * 0.1}s">
                    ...
                    <h3 class="font-display font-semibold text-lg mb-2 group-hover:text-accent transition-colors"
...
<section class="py-24 px-6">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <a href="mailto:ali.irsyaad.n@gmail.com" class="btn-primary inline-flex items-center gap-2">
